...
{
    public partial class yoneticipanel_beklemede_sikayet : Form
    {
       ...
       public int id;
        ...
        public yoneticipanel_beklemede_sikayet()
        {
            InitializeComponent();
        ...
        private void yoneticipanel_beklemede_sikayet_Load(object sender, EventArgs e)
        {
            OleDbConnection baglanti = new OleDbConnection("Provider=Microsoft.JET.OLEDB.4.0;Data Source=database.mdb");

            OleDbDataAdapter Adaptor = new OleDbDataAdapter("Select * from yardim_talebi where Durum='Beklemede' ", baglanti);
            ...
            aciklama.SetToolTip(bunifuFlatButton3, "Help");
