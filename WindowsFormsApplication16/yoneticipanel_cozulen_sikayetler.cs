...
{
    public partial class yoneticipanel_cozulen_sikayetler : Form
    {
        ...
        public yoneticipanel_cozulen_sikayetler()
        {
            InitializeComponent();
        ...
        private void yoneticipanel_cozulen_sikayetler_Load(object sender, EventArgs e)
        {
            OleDbConnection baglanti = new OleDbConnection("Provider=Microsoft.JET.OLEDB.4.0;Data Source=database.mdb");

            OleDbDataAdapter Adaptor = new OleDbDataAdapter("Select * from yardim_talebi where Durum='Çözüldü' ", baglanti);
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            OleDbCommand komut = new OleDbCommand();
            baglanti.Open();
            komut.CommandText = "Delete * from yardim_talebi where ID=" + textBox1.Text + "";
            komut.Connection = baglanti;
